...
public class GetTerminalsCashCommandTest {
    @Test
    public void commandCheck() throws Exception {
        Command command = new GetTerminalsCashCommand();
        Assert.assertEquals("getTerminalsCash", command.getName());
    ...
    public void parcelCheck() throws Exception {
        ...
        GetTerminalsCashCommand.CREATOR.createFromParcel(parcel);
        Assert.assertEquals(position, parcel.dataPosition());
        GetTerminalsCashCommand commands[] = GetTerminalsCashCommand.CREATOR.newArray(5);
